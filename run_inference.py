...
def run_inference(cfg):
    ...
    # Label encoding
    if featurize_dict['label_encode']['bool'] == True:
    ...
    # Feature scaling
    if featurize_dict['scaling']['bool'] == True:
    ...
    if (train_dict['bool'] == True) & (eval_dict['bool'] == True):
    ...
    elif (train_dict['bool'] == False) & (eval_dict['bool'] == True):
        pass
